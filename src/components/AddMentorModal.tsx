...
const AddMentorModal = ({ isOpen, onClose }: AddMentorModalProp) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="overflow-y-scroll scrollbar-thin scrollbar-thumb-yellow-500 scrollbar-track-transparent sm:max-w-[525px] h-4/5">
        <DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} value={field.value === undefined || field.value === null ? "" : String(field.value)} />
                  </FormControl>
                  <FormDescription />
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Tech Lead at IFS" {...field} />
                  </FormControl>
                  <FormDescription />
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="tel" placeholder="000-0000-000" {...field} />
                  </FormControl>
                  <FormDescription />
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Tutor since 2015" {...field} />
                  </FormControl>
                  <FormDescription />
                  <FormMessage />
                </FormItem>
